...
const TimeTracker = () => {
  const { activeEntry, activeBreak, clockIn, clockOut, startBreak, endBreak } =
    useTimeTracking();
  ...
  useEffect(() => {
    ...
    const calculateElapsed = () => {
      ...
      const totalMinutes =
        (new Date().getTime() - clockInTime.getTime()) / 60000 - breakMinutes;
      ...
      <div className="p-4">
        ...
        {activeEntry ? (
              ...
              {activeBreak ? (
                <div className="text-right text-warning-700">
                  ...
                  <div className="text-md font-medium">
                    {formatElapsedTime(elapsedBreakTime)}
                  </div>
                </div>
              ) : null}
            </div>
          ...
          <div className="flex flex-col items-center py-4">
            ...
            {error && <div className="mt-3 text-error-600">{error}</div>}
          </div>
        )}
